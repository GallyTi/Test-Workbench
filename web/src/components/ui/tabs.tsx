...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-10 items-center justify-center rounded-xl bg-white/[0.04] p-1 text-zinc-400 border border-white/[0.08] backdrop-blur-md',
      className
    )}
    {...props}
  />
